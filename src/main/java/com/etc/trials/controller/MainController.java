...
import com.etc.trials.service.ShiftManager;
import static com.etc.trials.service.WindowUtils.*;
...
public class MainController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
       // Set focus to welcome label
        ...
        Image img2 = new Image(Objects.requireNonNull(MainController.class.getResourceAsStream("/images/trials.png")));
