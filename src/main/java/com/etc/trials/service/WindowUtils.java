...
import com.etc.trials.controller.*;
import com.etc.trials.db.DEF;
...
import static com.etc.trials.logging.Logging.ERROR;
import static com.etc.trials.logging.Logging.logException;
...
public class WindowUtils {
   ...
   public static Stage OPEN_WINDOW_NOT_RESIZABLE_2(String fxmlPath, Runnable onCloseAction, Object controllerData) {
    ...
    public static void OPEN_WINDOW_WITH_CONTROLLER_AND_STAGE(String fxmlPath, Consumer<FileController> controllerHandler) {
        try {
    ...
    public static final String PREPARE_DATA = "/screens/CoreTables.fxml";
    public static final String DEPARTMENT_SECTION = "/screens/DepartmentSection.fxml";
    public static final String TRIALS_PAGE = "/screens/TrialsView.fxml";
    public static final String ADD_TRIAL_PAGE = "/screens/Trial.fxml";
    public static final String MEW_DASHBOARD_PAGE = "/screens/Dashboard.fxml";
...
public static void OPEN_ADD_TRIAL_PAGE(boolean reopenDashboardOnClose, TrialsViewController trialsViewController) {
    try {
        Runnable onClose = reopenDashboardOnClose ? WindowUtils::OPEN_MAIN_PAGE : null;
        // Pass the TrialsViewController as controllerData
        OPEN_WINDOW_NOT_RESIZABLE_2(ADD_TRIAL_PAGE, onClose, trialsViewController);
    } catch (Exception ex) {
    ...
    public static void OPEN_EDIT_TRIAL_PAGE(int trialId, Runnable onClose) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(LoginController.class.getResource("/screens/Trial.fxml"));
            Parent parent = fxmlLoader.load();

            TrialController controller = fxmlLoader.getController();
