...
import com.etc.trialsapp.service.ConfigLoader;
...
public class TrialController implements Initializable {
    ...
    @FXML private ComboBox<Material> material_combo;
   ...
   //     System.out.println("initialize called, stage: " + (stage != null ? stage.getTitle() : "null"));
        ...
        material_combo.setItems(materialDao.getAllMaterials());
    ...
    private void clearHelp() {
        ...
        material_combo.getSelectionModel().clearSelection();
        material_combo.setValue(null);
    ...
    private void addTrial() {
        try {
            ...
            Material selectedMaterial = material_combo.getValue();
            ...
            if (selectedMaterial == null) validationErrors.add("Select a material.");
            ...
            if (success) {
                ...
                clearHelp();
                // New Way
                TrialsViewController trialsViewController = TrialsViewController.getInstance();
                    if (trialsViewController != null) {
                Platform.runLater(() -> {
                    trialsViewController.refreshTable();
                });
            }else {
              //      System.out.println("TrialsViewController instance is null!");
                }
...
//                // Send email notification in a separate thread
    ...
    private final String mailPassword = userDao.getToolingRoom1Password();
    ...
    private void sendEmailNotification(String userFullName, String sectionName, String matrialName,
                                       ...
                                       String trialPurpose, String notes) {
        // Email configuration
        String fromEmail = mailName;
        String password = mailPassword;
        List<String> toEmails = new ArrayList<>();

        //toEmails.add("moh.gabr@elsewedy.com");   // Test
        ...
        try {
            ...
            if (logoStream == null) throw new IllegalStateException("Logo file not found at /images/etc_logo.png");
